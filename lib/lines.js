...
// Returns { street, mode } for a line code, or null if the line ends in a fold (terminal).
//   mode === 'facing' when the last action puts hero facing a bet/raise (B or R)
//   mode === 'bet'    when hero is the one to act first into the pot (X, C)
export function classifyLine(lineCode) {
